...
public class GameMode1 {
    ...
    public GameMode1(int i, int j, String[][] deck) {
        this.i = i;
        this.j = j;
        this.deck = deck;
    }
    ...
    public int chooseCard(int matchPar, int a, int b, int c, int d) {
        System.out.println("First card was: "+deck[a][b] + "\nSecond card was : " + deck[c][d]);
        if (deck[a][b].equals(deck[c][d])) {
            deck[a][b] = "_";
            deck[c][d] = "_";
            matchPar++;
    ...
    public void matrixAlter(int a, int b, int c, int d) {
        if (deck[a][b].equals(deck[c][d])) {
            deck[a][b] = "_";
            deck[c][d] = "_";
        }
